...
def cords_2_pixel(real_dist_cords,
                  pixel_center_location,
                  center_dist,
                  camera_height,
                  user_height,
...
# previous_robot_loc = np.array([0,0])import time
#
# import cv2 as cv
# import numpy as np
# # from sklearn.cluster import KMeans
...
#
#         dist_from_punch_traj = torch.norm(
#             torch.tensor([previous_robot_loc[0], punch_y_check], dtype=torch.float16).to(device) - previous_robot_loc)
#
