...
while cap.isOpened():
    ...
    if len(cord_list) == 2:
        ...
        real_centroid1 = centroid1#pixel_2_cords(centroid1, pixel_center, real_center_dist, cam_height, user_height, camera_orentation)
        real_centroid2 = centroid2#pixel_2_cords(centroid2, pixel_center, real_center_dist, cam_height, user_height, camera_orentation)
